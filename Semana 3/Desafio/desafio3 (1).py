...
def adivinar_numero():
    ...
    while intentos < 8:
        num_usuario = input("Adivina el número (entre 1 y 100) tienes 8 intentos: ")
...
# lo adivinó.
        ...
        if (numero_entero < numero_secreto):
            print("Demasiado bajo. Intenta nuevamente. Te quedan", (8-intentos),"intentos")
        elif (numero_entero > numero_secreto):
            print("Demasiado alto. Intenta nuevamente.Te quedan", (8-intentos),"intentos")
        else:
            print(f"¡Felicitaciones {nombre}! ¡Adivinaste el número en el {intentos} intento!")
            break
